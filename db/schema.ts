...
export const managedAppDevices = sqliteTable("managed_app_devices", {
  ...
  deviceClassOverride: text("device_class_override"),
  classificationConfidence: integer("classification_confidence").notNull().default(0),
  classificationSource: text("classification_source").notNull().default("legacy"),
  classifierVersion: integer("classifier_version").notNull().default(1),
  classificationDetailJson: text("classification_detail_json").notNull().default("{}"),
