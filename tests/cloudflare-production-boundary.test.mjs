...
test("production deploy stays push-disabled and one-shot Open Contract trigger is owner/PR scoped", () => {
  ...
  assert.ok(deploy.includes('github.event.issue.number }}" != "133"'));
  assert.ok(deploy.includes("/deploy-open-contract-catalog"));
