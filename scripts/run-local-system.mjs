...
async function main() {
  ...
  const nc03Origin = externalNc03Origin || "http://127.0.0.1:3010";
  ...
  if (!externalNc03Origin) {
    children.push(spawnService({
      name: "NC03",
      command: process.execPath,
      args: ["scripts/serve-local.mjs"],
      cwd: paths.nc03,
      env: { NC03_HOST: "127.0.0.1", NC03_PORT: "3010" },
    }));
  }
  children.push(spawnService({
    name: "BAUMAN-RUNTIME",
  ...
  const centralEnv = {
    ...
    HEALTH_CONTROL_SERVICE_LOCAL_SECRET: healthSecret,
    RU_LIFE_LOCAL_BASE_URL: "http://127.0.0.1:3002",
    RU_LIFE_CONTROL_SERVICE_LOCAL_SECRET: ruSecret,
    BAUMAN_CONTROL_LOCAL_BASE_URL: "http://127.0.0.1:3003",
    BAUMAN_APP_LOCAL_ORIGIN: baumanRuntimeOrigin,
    BAUMAN_CONTROL_SERVICE_LOCAL_SECRET: baumanSecret,
    BOI_ECH_LOCAL_BASE_URL: "http://127.0.0.1:3004",
    CONTROL_SERVICE_LOCAL_SECRET: boiSecret,
    NC03_LOCAL_BASE_URL: nc03Origin,
  ...
  console.log("\n===============================================================");
  console.log(" Local Control Plane đang hoạt động · 4 CLIENT CONTROL + NC03 RUNTIME");
  console.log("===============================================================");
