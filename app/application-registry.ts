...
export const applicationRegistry: readonly ApplicationConfig[] = [
  ...
  },
  {
    ...
    contractNote: "NC03 Control Center v0.7.0 đã qua professional QA/UX: telemetry 10 giây + last-known-good/timestamp, Home phân biệt rõ dữ liệu stale, pin ngoài 0–100 bị từ chối, keyboard/touch responsive được siết. Settings có báo cáo chẩn đoán A4 In/Lưu PDF theo allow-list read-only, loại trừ credential/token/session/PSK/IMEI/serial/ICCID/EID/eSIM/APN/raw rule. Report chạy cùng-origin, CSP-safe, payload chỉ đi qua URL fragment rồi được xóa khỏi history. AUTH/write vẫn khóa tới khi có capture thật và WRITE VERIFIED.",
