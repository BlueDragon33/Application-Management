...
export const applicationRegistry: readonly ApplicationConfig[] = [
  {
    ...
    contractNote: "Blueprint OS đã PASS Phase 8 và đang ở Phase 9 Compass Construction. P9-001–P9-006 đã COMPLETE; P9-007 Export / Backup / Restore đang ACTIVE tại Storey 16 với backup integrity, cross-project isolation và restore preview. Contract application-management.contract/v1 vẫn metadata-only: không Remote Admin, không Device Gate, không Quality Gate authority và không Production release authority.",
