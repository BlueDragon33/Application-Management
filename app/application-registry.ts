...
export const applicationRegistry: readonly ApplicationConfig[] = [
  ...
  },
  {
    ...
    contractNote: "Bauman có cây subjects và Math_Bauman đã tách repo, nhưng main hiện chưa có admin API/device/audit contract để Application Management điều khiển an toàn.",
