...
export const applicationRegistry: readonly ApplicationConfig[] = [
  {
    ...
    contractNote: "Blueprint OS đã PASS Phase 8 và đang ở Phase 9 Compass Construction. P9-001–P9-009 đã COMPLETE; P9-010 Bounded AI Copilot đang ACTIVE tại Storey 18 sau khi P9-009 vượt full Release Gate. Provider mới phải có project scope, capability whitelist, opaque credential reference và zero canonical/release authority. Contract application-management.contract/v1 vẫn metadata-only: không Remote Admin, không Device Gate, không Quality Gate authority và không Production release authority.",
