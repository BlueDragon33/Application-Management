...
export const applicationRegistry: readonly ApplicationConfig[] = [
  {
    ...
    contractNote: "Blueprint OS đã PASS Phase 8 và đang ở Phase 9 Compass Construction. P9-001–P9-008 đã COMPLETE; P9-009 Provider / Plugin Boundary đang ACTIVE tại Storey 17 sau khi P9-008 vượt full Release Gate. Provider mới phải có project scope, capability whitelist, opaque credential reference và zero canonical/release authority. Contract application-management.contract/v1 vẫn metadata-only: không Remote Admin, không Device Gate, không Quality Gate authority và không Production release authority.",
  ...
  },
  {
    ...
    contractNote: "NC03 Control Center v0.7.3 đã bổ sung HAR Evidence Lab ngay trong Advanced Developer Mode: HAR chỉ phân tích local, tách AUTH/WRITE evidence, redaction bí mật và xuất nc03-evidence.json an toàn. Read-path firmware 8.00.42, telemetry 10 giây, last-known-good, báo cáo A4 và privacy boundary vẫn giữ nguyên; AUTH/write tiếp tục fail-closed cho tới khi VERIFIED.",
