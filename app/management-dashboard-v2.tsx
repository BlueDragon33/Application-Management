...
function webActionLabel(app: ApplicationConfig, summary: OperationsSummary | undefined, hasWeb: boolean, busy = false) {
  if (busy) return "…";
  if (hasWeb) return "Mở";
